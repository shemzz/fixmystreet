...
subtest 'extra CSV columns are present if permission granted' => sub {
    ...
    is $rows[1]->[18], '', 'Reported As is empty if not made on behalf of another user/body';
    is $rows[1]->[19], '', 'Staff User is empty if not made on behalf of another user';
    ...
    is $rows[2]->[18], 'body', 'Reported As is correct if made on behalf of body';
    is $rows[2]->[19], '', 'Staff User is empty if not made on behalf of another user';
    ...
    is $rows[3]->[18], 'another_user', 'Reported As is set if reported on behalf of another user';
    is $rows[3]->[19], 'counciluser@example.com', 'Staff User is correct if made on behalf of another user';
    ...
    is $rows[4]->[18], 'anonymous_user', 'Reported As is set if reported on behalf of another user';
    is $rows[4]->[19], '', 'Staff User is empty if not made on behalf of another user';
